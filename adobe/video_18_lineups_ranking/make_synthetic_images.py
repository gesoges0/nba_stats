...
if __name__ == '__main__':
    ...
    # 背景画像ディレクトリ
    bg_images_dir = working_dir_root / 'lineups_20220109\\sozai_03\\output'

    # lineup画像のディレクトリ
    lineup_images_dir = working_dir_root / 'lineups_20220109\\sozai_02\\output'

    # チームロゴ画像のディレクトリ
    team_logo_images_dir = working_dir_root / 'logo_png_resized'

    # output
    output_images_dir = working_dir_root / 'lineups_20220109\\sozai_04'

    # 順位のTSV
    ranking_tsv_path = 'C:\\Users\\elasticnet\\Desktop\\nba_stats\\analysis\\' \
                       'analyze_00_longest_lineup\\MIN_20220109\\ranking_lineups.tsv'
